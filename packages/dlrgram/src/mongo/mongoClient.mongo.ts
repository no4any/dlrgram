...
import UserWithPassword from "../user/UserWithPassword.interface";
...
export const mongoCollectionUsers = mongoDb.collection<UserWithPassword>(MONGO_COLLECTION_USERS);